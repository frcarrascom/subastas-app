...
-- Tiempo de generación: 12-12-2022 a las 15:20:06
...
--
-- Base de datos: `wemerget_subastas`
--
...
(270, 1, 34, 'Subasta Ganada!!', 'Enhorabuena, has ganado la puja con nombre= Té verde japonés sakura cereza Club del Gourmet 15 bolsitas', 'VI', '2022-12-11 10:55:34'),
(271, 1, 34, 'Subasta Finalizada', 'Ha finalizado la subasta con nombre= Té verde japonés sakura cereza Club del Gourmet 15 bolsitas', 'VI', '2022-12-11 10:55:34'),
(272, 1, 4, 'Subasta Finalizada', 'Ha finalizado la subasta con nombre= Té verde japonés sakura cereza Club del Gourmet 15 bolsitas', 'NV', '2022-12-11 11:03:36'),
(273, 1, 4, 'Subasta Finalizada', 'Ha finalizado la subasta con nombre= Té verde japonés sakura cereza Club del Gourmet 15 bolsitas', 'NV', '2022-12-11 11:10:53'),
(275, 1, 34, 'Subasta Ganada!!', 'Enhorabuena, has ganado la puja con nombre= Té verde japonés sakura cereza Club del Gourmet 15 bolsitas', 'NV', '2022-12-12 05:36:06'),
(276, 1, 34, 'Subasta Finalizada', 'Ha finalizado la subasta con nombre= Té verde japonés sakura cereza Club del Gourmet 15 bolsitas', 'NV', '2022-12-12 05:36:06'),
(277, 46, 3, 'Prueba', 'Esto es una prueba', 'VI', '2022-12-12 10:36:58'),
(278, 3, 46, 'prueba', 'asdasd', 'NV', '2022-12-12 10:39:03'),
(279, 46, 3, 'dffsaf', 'Here you can use rows and columns here to organize your footer content.\r\n\r\nLorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit, error amet numquam iure provident voluptate esse quasi, veritatis totam voluptas nostrum.Here you can use rows and columns here to organize your footer content.\r\n\r\nLorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit, error amet numquam iure provident voluptate esse quasi, veritatis totam voluptas nostrum.Here you can use rows and columns here to ', 'NV', '2022-12-12 11:06:33');
...
(263, 3, 4, 'prueba 2', 'asdwadaw', 'BO', '0000-00-00 00:00:00'),
(264, 3, 24, 'asd', 'asd', 'BO', '0000-00-00 00:00:00'),
(265, 3, 3, 'dede', '', 'BO', '0000-00-00 00:00:00');
...
(87, '2022-11-24 00:00:00', '2022-11-23 00:00:00', 'finalizadaVisto', 'eReader - Kobo Clara 2E, Para eBook, 6 \", 16 GB, 300 ppp, 1448 x 1072, E-Ink, Az', 14, 1, 'Si tienes dispositivos que ya no usas, podemos darles una segunda vida.', 0.03, 3),
...
(95, '2022-11-30 00:00:00', '2022-12-31 00:00:00', 'activa', 'TV QLED 65\" - Samsung QE65QN85BATXXC, Neo QLED 4K, Procesador Neo QLED 4K con IA', 14545.5, 5, 'Mejor televisor del mercado', 0.03, 4),
(104, '2022-10-11 00:00:00', '2022-12-08 00:00:00', 'finalizadaVisto', 'TV QLED 65\" - Samsung QE65QN85BATXXC, Neo QLED 4K, Procesador Neo QLED 4K con IA', 1500, 16, 'TV DE PRUEBA PARA BORRAR', 0.03, 35),
...
(107, '2022-12-08 00:00:00', '2022-12-11 00:00:00', 'finalizadaVisto', 'Té verde japonés sakura cereza Club del Gourmet 15 bolsitas', 10, 2, 'Esta deliciosa mezcla de té verde te transporta hasta Japón. Su sabor, marcado claramente por la cereza, es todo un deleite para el paladar. Más que un té, es una golosina.\r\n\r\nUn aroma y sabor suave con un toque ácido y afrutado. Posee un color verde amarillento con un resultado excepcional.\r\n\r\nProcedente de Japón.', 0.05, 3),
(108, '2022-12-12 00:00:00', '2022-12-15 00:00:00', 'activa', 'Zapatillas casual de mujer Rider FV Future Vintage Puma', 150, 12, 'Con un pie en el pasado y el otro pie en el futuro: las zapatillas Rider Future Vintage de PUMA combinan un upper throwback con nuevos detalles frescos. Da tu siguiente paso en lo último al estilo de la vieja escuela.', 0.03, 43);
...
(113, 107, 4, 11, '2022-12-11 10:51:36'),
(114, 107, 4, 12, '2022-12-11 10:51:37'),
(115, 107, 34, 13, '2022-12-11 10:51:47'),
(116, 107, 34, 14, '2022-12-11 10:51:49'),
(117, 106, 34, 12, '2022-12-11 10:51:59'),
(118, 106, 34, 13, '2022-12-11 10:52:00'),
(119, 106, 34, 14, '2022-12-11 10:52:01'),
(121, 94, 3, 246, '2022-12-11 17:25:55'),
(122, 18, 3, 201, '2022-12-12 04:00:05'),
(123, 19, 44, 15003, '2022-12-12 04:32:29'),
(124, 88, 45, 150, '2022-12-12 09:40:01'),
(125, 108, 3, 151, '2022-12-12 10:45:04'),
(126, 108, 3, 152, '2022-12-12 10:45:40'),
(127, 108, 46, 155, '2022-12-12 10:46:13'),
(128, 106, 46, 3123, '2022-12-12 10:50:59'),
(129, 106, 46, 65556.11, '2022-12-12 10:51:19'),
(130, 18, 47, 500, '2022-12-12 14:14:27');
...
(3, 'dedede', 'dedede', 'dede', 'dede@gmail.com', 'dede'),
...
(38, 'asd', 'asd', 'asd', 'eliminar@gmail.com', 'assd'),
(43, 'Francisco', 'Carrasco Merchan', 'pcm', 'carrascomerchan@msn.com', '1234'),
(44, 'errtey', 'erty', 'qwerty', 'erty@asdf.com', 'qwerty'),
(45, 'Kaiik', 'Kaiiku', 'Iomismo', 'emanzanog03@gmail.com', 'Pass1234'),
(46, 'Paco', 'Pepe', 'pacopepe', 'pacopepe@gmail.com', 'pacopepe'),
(47, 'Daniel', 'Garcia', 'Danny', 'dnlgah@gmail.com', '1234');
...
--
ALTER TABLE `mensajes`
  MODIFY `codMensaje` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=281;

--
-- AUTO_INCREMENT de la tabla `mensajesborrados`
--
ALTER TABLE `mensajesborrados`
  MODIFY `codMensaje` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=266;

--
-- AUTO_INCREMENT de la tabla `productosubastado`
--
ALTER TABLE `productosubastado`
  MODIFY `codProductoSubastado` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;

--
-- AUTO_INCREMENT de la tabla `puja`
--
ALTER TABLE `puja`
  MODIFY `codPuja` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;

--
-- AUTO_INCREMENT de la tabla `usuario`
--
ALTER TABLE `usuario`
  MODIFY `codUsuario` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
