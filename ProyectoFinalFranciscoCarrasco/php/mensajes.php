                        ...
                        if ($meR->getEstado() !== 'VI') {
                            ...
                            <div class="card m-2 border-primary" style="width: 90%;">
                                <div class="card-body text-primary row">
                                    <p class="card-title col-sm-12 col-md-2 col-lg-1 mt-3">Enviado
                                        por: <?php echo $usuarioEmisor->getNombre() ?></p>
                                    <p class="card-text col-sm-12 col-md-2 col-lg-2 mt-3">
                                        Asunto: <?php echo $meR->getAsunto() ?></p>
                                    <p class="card-text col-sm-12 col-md-2 col-lg-2 mt-3">
                                        Enviado: <?php echo $meR->getFecha() ?></p>
                                    <p class="card-text col-sm-12 col-md-4 col-lg-4 mt-3">
                                        Mensaje: <?php echo $meR->getMensaje() ?></p>
                                    <button class='btn btn-outline-danger col-sm-12 col-md-1 col-lg-1 mt-2 ml-auto'
                                            onclick="javascript:window.location='mensajes.php?borrar=<?php echo $meR->getCodMensaje() ?>';">
                                        <i class="fa fa-trash" aria-hidden="true"></i></button>
                                    <button class='btn btn-outline-success col-sm-12 col-md-1 col-lg-1 ml-5 mt-2 mr-2'
                            ...
                            <div class="card m-2" style="width: 90%;">
                                <div class="card-body row">
                                    ...
                                    <p class="card-text col-sm-12 col-md-4 col-lg-4 mt-3">
                                        Mensaje: <?php echo $meR->getMensaje() ?></p>
                                    <button class='btn btn-outline-danger col-sm-12 col-md-2 col-lg-1 mt-2 ml-auto p-2'
                                            onclick="javascript:window.location='mensajes.php?borrar=<?php echo $meR->getCodMensaje() ?>';">
                                        <i class="fa fa-trash" aria-hidden="true"></i></button>
                                    <button class='btn btn-outline-success col-sm-12 col-md-2 col-lg-1 ml-5 mt-2 mr-2'
                                            onclick="javascript:window.location='mensajes.php?leido=<?php echo $meR->getCodMensaje() ?>';">
                        ...
                        <div class="card m-2" style="width: 90%;">
                            <div class="card-body row ">
                                <p class="card-title col-sm-12 col-md-2 col-lg-2 mt-3">Mensaje enviado
                                    a <?php echo $usuarioReceptor->getNombre() ?></p>
                                <p class="card-text col-sm-12 col-md-2 col-lg-2 mt-3">
