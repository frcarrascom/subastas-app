        ...
        <div class="container-fluid justify-content-center m-0 ">
            <div class="card m-2" style="width: auto;">
                <div class="card-body">
                    ...
                    <p>Dinero a Invertir en Categoría: <?php echo number_format($dineroInvertir, 2, ',', '.') ?>€</p>
                    <p>Fecha Inicio: <?php echo $resultado->getFechaInicio() ?></p>
                    <p>Fecha Final: <?php echo $resultado->getFechaFin() ?></p>
                </div>
                <div class="card-footer">
                    <p>Precio Inicial: <?php echo number_format($resultado->getPrecio(), 2, ',', '.') ?>€</p>
                    <p>Precio Última Puja: <?php echo number_format($cantidad, 2, ',', '.') ?>€</p>
                </div>
            </div>
        </div>
